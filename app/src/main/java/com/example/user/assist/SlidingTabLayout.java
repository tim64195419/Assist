...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    // tab title
    private static final int TAB_TITLE_PADDING_DIPS_TOP = 10;
    private static final int TAB_TITLE_PADDING_DIPS_BOTTOM = 10;
    private static final int TAB_TITLE_PADDING_DIPS_LEFT = 0;
    private static final int TAB_TITLE_PADDING_DIPS_RIGHT = 10;
    // tab img
    private static final int TAB_ICON_PADDING_DIPS_TOP = 10;
    private static final int TAB_ICON_PADDING_DIPS_BOTTOM = 10;
    private static final int TAB_ICON_PADDING_DIPS_LEFT = 10;
    private static final int TAB_ICON_PADDING_DIPS_RIGHT = 10;

    private static final int TAB_TITLE_TEXT_SIZE_SP = 20;
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_TITLE_TEXT_SIZE_SP);
        ...
        int top = (int) (TAB_TITLE_PADDING_DIPS_TOP * getResources()
                .getDisplayMetrics().density);
        int bot = (int) (TAB_TITLE_PADDING_DIPS_BOTTOM * getResources()
                .getDisplayMetrics().density);
        int left = (int) (TAB_TITLE_PADDING_DIPS_LEFT * getResources()
                .getDisplayMetrics().density);
        int right = (int) (TAB_TITLE_PADDING_DIPS_RIGHT * getResources()
                .getDisplayMetrics().density);

        textView.setPadding(left, top, right, bot);

        return textView;
    }

    private TextView AlterTextView(View v) {
        TextView textView = (TextView) v.findViewById(mTabViewTextViewId);
        textView.setGravity(Gravity.CENTER);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_TITLE_TEXT_SIZE_SP);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            // If we're running on Honeycomb or newer, then we can use the
    ...
    private ImageView AlterImageView(View v) {
        ImageView imgView = (ImageView) v.findViewById(mTabViewImageViewId);

        int top = (int) (TAB_ICON_PADDING_DIPS_TOP * getResources()
                .getDisplayMetrics().density);
        int bot = (int) (TAB_ICON_PADDING_DIPS_BOTTOM * getResources()
                .getDisplayMetrics().density);
        int left = (int) (TAB_ICON_PADDING_DIPS_LEFT * getResources()
                .getDisplayMetrics().density);
        int right = (int) (TAB_ICON_PADDING_DIPS_RIGHT * getResources()
                .getDisplayMetrics().density);

        imgView.setPadding(left, top, right, bot);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabTitleView = AlterTextView(tabView);
                tabIconView = AlterImageView(tabView);
